...
To perform these tasks we require a platform to label the dataset or take any available COCO model dataset.

Link to Ultralytics Platform for training and Labelling:
  https://platform.ultralytics.com/home

In this platform you can annotate and use to train the labled dataset for any YOLO model.
Steps:
  1. Upload the dataset images by creating a New Dataset option.
  2. Choose the Annotate option in the left taskbar. Fill the required field like dataset name, task type, visibility public or private. Upload all your images and click on create Dataset.
     
<img width="1515" height="708" alt="image" src="https://github.com/user-attachments/assets/3cb85727-d072-42b9-84d6-6e126298aa60" />

  3. After uploading all the images you can start annotating Images One by One until all the images get annotated.
